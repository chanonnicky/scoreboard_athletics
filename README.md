...
- **กราฟิกหลัก — `แถบล่าง` กับ `เต็มจอ` ขึ้นได้ทีละอันเดียว** (ขึ้นอันใหม่ อันเดิมลงเอง)
  - `แถบล่าง` — **อันดับ 1–3** (แถบยาว เหรียญ 1/2/3 อันดับ 1 เด่นสุด)
  - `เต็มจอ` — 3 แบบ:
...
- **`Score bug` — ช่องอิสระ ค้างจอได้พร้อมกับกราฟิกหลัก** เลือกกีฬาที่จะโชว์สกอร์สด
  (สกอร์ + นาฬิกานับถอยหลัง + จุด LIVE) ทีละ 1 กีฬา — สั่งจากหัวข้อ "Score bug" ในหน้าคุม
