...
**2 ช่องแสดงผล (slot) — `แถบล่าง` กับ `เต็มจอ` ขึ้นพร้อมกันได้:**
- `แถบล่าง` — lower-third เลือกได้:
  - **อันดับ 1–3** (แถบยาว เหรียญ 1/2/3 อันดับ 1 เด่นสุด)
  - **สด <กีฬา>** — แถบสกอร์คู่ที่กำลังแข่งของฟุตซอล/บาส (สกอร์ + นาฬิกานับถอยหลัง + จุด LIVE)
- `เต็มจอ` — 3 แบบ:
...
แต่ละช่องขึ้นอันใหม่ อันเก่าในช่องนั้นจะลงเอง (กด "ลงจอทั้งหมด" เพื่อเคลียร์ทั้งคู่) — ทั้งสองช่องอยู่บน
overlay อันเดียว ตั้งใน OBS/vMix ครั้งเดียวพอ · เอาแถบสกอร์สดของกีฬาหนึ่งไปคู่กับ "ตารางการแข่งขัน"
หรือใช้เดี่ยว ๆ จะสวยที่สุด (การ์ดเต็มจอสูง ๆ อาจทับแถบล่างได้) · โลโก้โรงเรียนขึ้นบน CG ทุกแบบ
